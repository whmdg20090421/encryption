...
import com.whmdg.mczj.tools.security.AccessibilityServiceBridge
import kotlinx.coroutines.suspendCancellableCoroutine
import kotlin.coroutines.resume

class MyAccessibilityService : AccessibilityService(), AccessibilityServiceBridge {
    ...
    override fun onServiceConnected() {
        ...
        instance = this
        AccessibilityServiceBridge.implementation = this
    }

    override fun onDestroy() {
        AccessibilityServiceBridge.implementation = null
        instance = null
        super.onDestroy()
    }

    // ── AccessibilityServiceBridge 接口实现 ──
    ...
    override fun suppressAutoRecognize() {
        Companion.suppressAutoRecognize()
    }

    override val currentLastClassName: String?
        get() = lastClassName
